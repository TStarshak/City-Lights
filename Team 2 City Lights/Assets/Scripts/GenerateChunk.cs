...
public class GenerateChunk : MonoBehaviour {
    ...
    private int currentLandmark = 5;
    private int sizeX = 7;
    private int sizeY = 7;
    private int chunkSizeX = 28;
    private int chunkSizeY = 28;
    private List<int> forSale = new List<int>();
    private List<int> infSale = new List<int>();
    private List<int[][]> chunkData = new List<int[][]>();
    private List<Vector3> lakeInf = new List<Vector3>();
    public List<GameObject> landmarkData = new List<GameObject>();
    ...
    void Start() {
        ...
        //place landmarks
        while(currentLandmark > 0) {
            int currentChunk = rand.Next(0, forSale.Count);
            int infChunk = infSale[currentChunk];
            int xBuf = currentChunk % sizeY;
            int xSpace = xBuf * chunkSizeX - ((sizeX * chunkSizeX) / 2);
            int ySpace = (((currentChunk - xBuf) / sizeX) * chunkSizeY) - ((sizeY * chunkSizeY) / 2);
            Debug.Log(currentChunk);
            Debug.Log(xSpace);
            Debug.Log(ySpace);


            //check that you can place the landmark there
            GameObject V1 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) - 1).ToString() + 'Y' + ((chunkSizeY / 2) - 1).ToString() + 'Z' + '0' + 'R' + infChunk));
            GameObject V2 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) - 1).ToString() + 'Y' + ((chunkSizeY / 2) + 1).ToString() + 'Z' + '0' + 'R' + infChunk));
            GameObject V3 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) + 1).ToString() + 'Y' + ((chunkSizeY / 2) - 1).ToString() + 'Z' + '0' + 'R' + infChunk));
            GameObject V4 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) + 1).ToString() + 'Y' + ((chunkSizeY / 2) + 1).ToString() + 'Z' + '0' + 'R' + infChunk));

            GameObject I1 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) - 1).ToString() + 'Y' + ((chunkSizeY / 2) - 1).ToString() + 'Z' + '1' + 'R' + infChunk));
            GameObject I2 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) - 1).ToString() + 'Y' + ((chunkSizeY / 2) + 1).ToString() + 'Z' + '1' + 'R' + infChunk));
            GameObject I3 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) + 1).ToString() + 'Y' + ((chunkSizeY / 2) - 1).ToString() + 'Z' + '1' + 'R' + infChunk));
            GameObject I4 = GameObject.Find((string)('I' + currentChunk.ToString() + 'X' + ((chunkSizeX / 2) + 1).ToString() + 'Y' + ((chunkSizeY / 2) + 1).ToString() + 'Z' + '1' + 'R' + infChunk));
